...
# takes care of MLNet and some part of RL
...
class DashCamEnv(core.Env):
    ...
    def get_reward(self, score_pred, fix_pred):         ## can try
        ...
        r_tta = (tta_weights * xnor_dist).unsqueeze(1)      ## this is the dense anticipation reward
